<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommodityInfo.aspx.cs" Inherits="TruckManagementSystem.CommodityInfo" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div class="jumbotron">
                <H1 class="text-danger">Commodity Truck Info</H1>
            </div>
            <asp:GridView ID="grdDriverInfo" OnRowDataBound="grdDriverInfo_RowDataBound" OnRowCommand="grdDriverInfo_RowCommand" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnGetinfo" CommandName="Getnumber" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server" Text="Get in touch" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
